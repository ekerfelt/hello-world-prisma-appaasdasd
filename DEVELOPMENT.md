...
```bash
git remote add encore encore://hello-world-prisma-app-fnmi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hello-world-prisma-app-fnmi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hello-world-prisma-app-fnmi/settings/integrations/github)
